...
//   PURPOSE: Verify sync command behavior for strict current-only vvoc config handling.
//   SCOPE: Command-level invalid existing config rejection without rewrite and preservation of valid current plugin toggles.
