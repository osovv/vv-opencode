...
//   SCOPE: Current trailing-whitespace-insensitive line hash computation, context-anchored hash computation, plus formatting helpers for rendered hashline rows.
